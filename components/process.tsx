const steps = [
  {
    ...
    description:
      'We talk through your goals, your schedule, and what\'s worked or hasn\'t. No pressure, no pitch.',
  },
  {
    number: '02',
  ...
  },
  {
    ...
    description:
      'Weekly check-ins, program refinements, forward momentum. That\'s it.',
  },
]

export default function Process() {
  return (
    <section id="process" className="bg-[#0D0D0D] py-24 lg:py-32 border-t border-[#2A2A2A]">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-[#2A2A2A]">
          {steps.map((step) => (
            <div key={step.number} className="py-10 md:py-0 md:px-12 first:md:pl-0 last:md:pr-0 flex flex-col gap-6">
              <span
